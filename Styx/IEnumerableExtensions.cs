...
/*
        ...
        public static Sniper<TMessage> ToSniper<TMessage>(this IEnumerable<TMessage> IEnumerable, Boolean Autostart, Boolean StartAsTask, Nullable<TimeSpan> InitialDelay)
        {
        ...
        {
            return new Sniper<TMessage>(IEnumerable, false, false, null);
        }
